 ...
 */
package com.thibault01.knet_replay_kore.jsonrpc.method;
...
import com.thibault01.knet_replay_kore.jsonrpc.ApiException;
import com.thibault01.knet_replay_kore.utils.JsonUtils;
...
public class Application {
    ...
    public static final class SetVolume extends ApiMethod<Integer> {
        ...
        /**
         * Set the current volume
         * @param volume String enum in {@link GlobalType.IncrementDecrement}
         */
