...
package com.thibault01.knet_replay_kore.ui.viewgroups;
...
public class DynamicListView extends ListView {
     ...
     * callbacks {@link DynamicListView.DynamicListAdapter#onSwapItems(int, int)}
     * and {@link DynamicListView.DynamicListAdapter#onSwapFinished(int, int)}
     *
