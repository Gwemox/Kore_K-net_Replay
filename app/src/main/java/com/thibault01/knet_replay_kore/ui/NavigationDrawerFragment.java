...
import com.thibault01.knet_replay_kore.ui.hosts.HostManagerActivity;
...
public class NavigationDrawerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ArrayList<DrawerItem> items = new ArrayList<>(16);
        ...
        if (shownItems.contains(String.valueOf(ACTIVITY_REPLAYS)))
            items.add(new DrawerItem(DrawerItem.TYPE_NORMAL_ITEM, ACTIVITY_REPLAYS,
                    getString(R.string.replays),
                    styledAttributes.getResourceId(ACTIVITY_REPLAYS, 0)));
    ...
    static {
        ...
        activityItemIdMap.put(ACTIVITY_REPLAYS, ReplayActivity.class);
