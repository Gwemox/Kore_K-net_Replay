 ...
 */
package com.thibault01.knet_replay_kore.ui.hosts;
...
import com.thibault01.knet_replay_kore.jsonrpc.method.Settings;
import com.thibault01.knet_replay_kore.service.LibrarySyncService;
import com.thibault01.knet_replay_kore.ui.NavigationDrawerFragment;
...
public class AddHostFragmentFinish extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (hostManager.getHostInfo() != null) {
            ...
            String prefKey = com.thibault01.knet_replay_kore.Settings.KEY_PREF_CHECKED_PVR_ENABLED + String.valueOf(hostManager.getHostInfo().getId());
...
//                        .getWindowToken(), 0);
    ...
    public static void checkPVREnabledAndSetMenuItems(final Context context, Handler handler) {
        ...
        Settings.GetSettingValue getSettingValue =
                new Settings.GetSettingValue(Settings.PVRMANAGER_ENABLED);
        getSettingValue.execute(conn, new ApiCallback<JsonNode>() {
            ...
            public void onSuccess(JsonNode result) {
                ...
                sp.edit()
                  .putStringSet(com.thibault01.knet_replay_kore.Settings.getNavDrawerItemsPrefKey(hostId), shownItems)
                  .apply();
            }
