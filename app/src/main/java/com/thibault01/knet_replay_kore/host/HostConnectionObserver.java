 ...
 */
package com.thibault01.knet_replay_kore.host;
...
import com.thibault01.knet_replay_kore.jsonrpc.notification.Player;
import com.thibault01.knet_replay_kore.jsonrpc.type.PlayerType;
import com.thibault01.knet_replay_kore.utils.LogUtils;
import com.thibault01.knet_replay_kore.jsonrpc.method.JSONRPC;
import com.thibault01.knet_replay_kore.jsonrpc.notification.Input;
import com.thibault01.knet_replay_kore.jsonrpc.notification.System;
...
public class HostConnectionObserver
    ...
    public interface PlayerEventsObserver {
         ...
         * @param getActivePlayerResult Active player obtained by a call to {@link com.thibault01.knet_replay_kore.jsonrpc.method.Player.GetActivePlayers}
         * @param getPropertiesResult Properties obtained by a call to {@link com.thibault01.knet_replay_kore.jsonrpc.method.Player.GetProperties}
         * @param getItemResult Currently playing item, obtained by a call to {@link com.thibault01.knet_replay_kore.jsonrpc.method.Player.GetItem}
         */
         ...
         * @param getActivePlayerResult Active player obtained by a call to {@link com.thibault01.knet_replay_kore.jsonrpc.method.Player.GetActivePlayers}
         * @param getPropertiesResult Properties obtained by a call to {@link com.thibault01.knet_replay_kore.jsonrpc.method.Player.GetProperties}
         * @param getItemResult Currently paused item, obtained by a call to {@link com.thibault01.knet_replay_kore.jsonrpc.method.Player.GetItem}
         */
...
//        observerHandlerMap.remove(observer);
     ...
     */
    public void onPlay(com.thibault01.knet_replay_kore.jsonrpc.notification.Player.OnPlay notification) {
        // Just start our chain calls
        chainCallGetActivePlayers();
    }

    public void onPause(com.thibault01.knet_replay_kore.jsonrpc.notification.Player.OnPause
                                notification) {
        // Just start our chain calls
        chainCallGetActivePlayers();
    }
    ...
    public void onSeek(com.thibault01.knet_replay_kore.jsonrpc.notification.Player.OnSeek notification) {
        // Just start our chain calls
        chainCallGetActivePlayers();
    }

    public void onStop(com.thibault01.knet_replay_kore.jsonrpc.notification.Player.OnStop notification) {
        // Just start our chain calls
    ...
    private void chainCallGetActivePlayers() {
        com.thibault01.knet_replay_kore.jsonrpc.method.Player.GetActivePlayers getActivePlayers = new com.thibault01.knet_replay_kore.jsonrpc.method.Player.GetActivePlayers();
    ...
    private void chainCallGetProperties(final PlayerType.GetActivePlayersReturnType getActivePlayersResult) {
        ...
        com.thibault01.knet_replay_kore.jsonrpc.method.Player.GetProperties getProperties = new com.thibault01.knet_replay_kore.jsonrpc.method.Player.GetProperties(getActivePlayersResult.playerid, propertiesToGet);
...
//        propertiesToGet = ListType.FieldsAll.allValues;
        com.thibault01.knet_replay_kore.jsonrpc.method.Player.GetItem getItem = new com.thibault01.knet_replay_kore.jsonrpc.method.Player.GetItem(getActivePlayersResult.playerid, propertiesToGet);
